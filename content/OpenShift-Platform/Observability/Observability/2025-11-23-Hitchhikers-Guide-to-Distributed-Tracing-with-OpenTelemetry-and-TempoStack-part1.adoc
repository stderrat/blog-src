...
featured_image: /openshift-platform/observability/images/observability/Logo_observability_1.png?width=416px
...
aliases: [ 
	 "/day-2/observability/2025-11-23-hitchhikers-guide-to-distributed-tracing-with-opentelemetry-and-tempostack-part1/",
]
---
