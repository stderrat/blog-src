...
featured_image: /openshift-platform/observability/images/observability/Logo_observability_5.png
...
aliases: [ 
	 "/day-2/observability/2025-11-27-hitchhikers-guide-to-distributed-tracing-with-opentelemetry-and-tempostack-part5/",
]
---
