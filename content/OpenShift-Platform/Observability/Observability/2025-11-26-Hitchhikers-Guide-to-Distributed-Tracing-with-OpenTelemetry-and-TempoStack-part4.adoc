...
featured_image: /openshift-platform/observability/images/observability/Logo_observability_3.png
...
aliases: [ 
	 "/day-2/observability/2025-11-26-hitchhikers-guide-to-distributed-tracing-with-opentelemetry-and-tempostack-part4/",
]
---
...
NOTE: Above will end up in a ConfigMap that is managed by the OpenShift GitOps operator.
