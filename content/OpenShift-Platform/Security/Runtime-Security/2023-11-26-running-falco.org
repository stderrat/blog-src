...
#+hugo_base_dir: ../
#+OPTIONS: ^:nil
#+aliases[]: /openshift/2023/11/running-falco-on-openshift-4.12/
...
#+begin_src plantuml :file /openshift-platform/security/runtime-security/images/falco/falco-pipeline.png :exports results :results none
@startuml
component Falco {
	file audit.log
...
[[file:/openshift-platform/security/runtime-security/images/falco/falco-pipeline.png]]
