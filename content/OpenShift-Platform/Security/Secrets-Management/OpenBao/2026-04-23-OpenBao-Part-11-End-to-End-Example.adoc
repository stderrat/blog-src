--- 
title: "The Guide to OpenBao - End-to-End Example - Part 11"
...
* **Part 6**: Authentication methods (Kubernetes, OIDC, LDAP, AppRole)
* **Part 7**: Secrets engines (KV, PKI, Database, Transit)
* **Part 8**: Kubernetes integration patterns
* **Part 9**: High availability and production best practices
