--- 
title: "The Guide to OpenBao - End-to-End Example - Part 13"
...
aliases: [ 
	 ...
	 "/openshift-platform/security/secrets-management/openbao/2026-04-23-openbao-part-12-end-to-end-example/",
]
---
...
* External Secrets Operator installed (Part 10)
...
* **Part 4**: Enabling TLS on OpenShift with cert-manager
* **Part 5**: GitOps deployment with Argo CD
* **Part 6**: Initialisation, unsealing, and auto-unseal
* **Part 7**: Authentication methods (Kubernetes, OIDC, LDAP, AppRole)
* **Part 8**: Secrets engines — KV
* **Part 9**: Secrets engines — PKI and cert-manager
* **Part 10**: Kubernetes integration patterns
* **Part 11**: High availability and production best practices
* **Part 12**: Operations and troubleshooting
* **Part 13**: Complete end-to-end example
