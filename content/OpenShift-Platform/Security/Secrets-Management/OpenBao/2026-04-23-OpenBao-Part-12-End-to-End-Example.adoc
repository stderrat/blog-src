--- 
title: "The Guide to OpenBao - End-to-End Example - Part 12"
...
* External Secrets Operator installed (Part 9)
...
* **Part 8**: Secrets engines (KV, PKI, Database, Transit)
* **Part 9**: Kubernetes integration patterns
* **Part 10**: High availability and production best practices
* **Part 11**: Operations and troubleshooting
* **Part 12**: Complete end-to-end example
