--- 
title: "The Complete Guide to OpenBao - GitOps Deployment with Argo CD - Part 4"
...
aliases: [ 
	 "/openshift/security/openbao/2026-02-11-openbao-gitops-deployment/",
]
---
...
Configure auto-unseal to eliminate manual unsealing. This is covered in detail in Part 8.
...
In Part 5, we will configure authentication methods for OpenBao:
...
* Consider auto-unseal for production (Part 8)
