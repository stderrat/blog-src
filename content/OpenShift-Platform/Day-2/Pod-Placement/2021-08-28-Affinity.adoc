...
aliases: [ 
	 ...
	 "/day-2/pod-placement/2021-08-28-affinity/",
] 
---

:imagesdir: /openshift-platform/day-2/images/
:icons: font
:toc:
...
As described in the Kubernetes documentation at https://kubernetes.io/docs/concepts/scheduling-eviction/assign-pod-node/#inter-pod-affinity-and-anti-affinity[Pod Affinity and Anti-Affinity^], the topologyKey has some constraints:
