...
NOTE: As image for the sidecar container, I am using the custom built https://quay.io/repository/tjungbau/gitops-tools[GitOps Tools^] image. You can use your own image, as long as Helm and Kustomize are available. 
    ...
    sidecarContainers: <2>
      - name: my-cmp-plugin 
        ...
        env: 
          - name: APP_ENV 
            value: prod 
        image: quay.io/repository/tjungbau/gitops-tools <3>
...
* G.Nunn's original tools image (Thanks for everything):  https://quay.io/repository/gnunn/tools 
* My custom built tools image:  https://quay.io/repository/tjungbau/gitops-tools
